          ...
          <div class="col-md-6">
            <div class="row" id="header_email">
              <div class="col-md-6 header_text">
                ...
                <a class="header_text" href="www.gmail.com">daksha.1rn17cs031@gmail.com</a>
              </div>
              <div class="col-md-6 header_text " style="height: 32;line-height: 32px;">
                ...
                <a class="header_text" href="#">(+91)7259163407</a>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6" style="padding-top: 30;">
          <table id="table">
            <div>
              ...
              <tr><td><p id="para1">hssgghghnghksgnhghbghbhgbhdghgbhgbhghghskgsgbh
              </p></td> </tr>
            </div>
            <tr><td><button onclick="window.location.href='/page2'" id="sub">READ MORE</button></td></tr>
            <tr><td><p id="vis">OUR VISION & MISSION</p></td></tr>
            <tr><td ><p id="para2">hsghngndgjhdgkdgdngndgndgndngjdgnjdgndgjnjdgdgdgndjggjdgnjdgndgj</p></td></tr>
            <tr><td><button onclick="window.location.href='/page2'" id="sub">READ MORE</button></td></tr>
          </table>
        </div>
      </div>
  ...
  <div id="section6" class="container-fluid">
     <div class="container">
      ...
      <div class="cont" id="niket" >
        ...
        <p>
        ujfsgnisngisngiisgnngnsgnsjungusjngjrgjrngjnrginnrngjnrgnbrjngnjnn</p>
        ...
        <div class="cont" id="niket1" style="display:none;">
          <h2>Gynaecology</h2>
          <p>
         ghbirehgrhgrgnihrngigrgrigirgirhgirhgirgihrighsugsignsgngnsignigni</p>

        </div>
        <div class="cont" id="niket2" style="display:none;">
          <h2>Microbiology</h2>
          <p>
          sbhgghshgbsngknjkskgkj gkaa jbhhbjh nkjbkb kbgkbb kjbkb fjjb </p>

        </div>
        <div class="cont" id="niket3" style="display:none;">
          <h2>Rheutomology</h2>
          <p>
           hggs gb bgksjbksj bfnbb jfbnjfkbnkdfbnksjsksjlbksfnbknsfjb kf nbkf bk </p>

        </div>
        <div class="cont" id="niket4" style="display:none;">
          <h2>Neonatal</h2>
          <p>
          hrbgisrgnbrnsginrignrsinrgnsrnrjsnhnhij</p>

        </div>
        <div class="cont" id="niket5" style="display:none;">
          <h2>Nephrology</h2>
          <p>
         hbevjehbgjebsdgbjdhgebjhsbgbjshebghjbsejg</p>

        </div>
        <div class="cont" id="niket6" style="display:none;">
          <h2>Neurology</h2>
          <p>
          hrgrhnggiegisgnngingijnihnjishisnhihnihnihinisjh</p>

        </div>
        <div class="cont" id="niket7" style="display:none;">
          <h2>Obstetrics</h2>
          <p>
         bgsirgirsngrgjnsngsjgsjnsjgnnhjnshnjsnshnjh</p>

        </div>
        <div class="cont" id="niket8" style="display:none;">
          <h2>Oncology</h2>
          <p>
          hbghsrgrsngjngkjsgjsngjrhnhjhninjhsnsjhn</p>
        ...
        <div class="cont" id="niket10" style="display:none;">
          <h2>Pharmacy</h2>
          <p>
          nedsgjnsjgsjnrnjgsrhnjrhjrjhjrhj</p>

        </div>
        <div class="cont" id="niket11" style="display:none;">
          <h2>Radiotherapy</h2>
          <p>
          jrfnbskrnhjrnhrjknrjnhjrnhrjdh</p>
